  ...
  return (
    <div >
      ...
      <div style={{background:"#F2F5F8",height:"1600px"}}>
       ...
       <div style={{width:"600px",height:"1250px",padding:"20px",marginLeft:"450px"}}>
       ...
       <div style={{textAlign:"center"}}>
              <div style={{width:"500px",marginLeft:"460px"}}>By placing your order, you accept our Terms and Conditions , our Privacy Policy and our Returns Policy . You also agree that some of your data will be stored by ASOS. These can be used to make your shopping experience even better in the future.</div>
              <div className='btn LastBtn' onClick={cashD}>CASH ON DELIVERY</div><br />
              <button disabled  className='btn LastBtn'>ONLINE PAYMENT</button>
            </div>
      </div>
